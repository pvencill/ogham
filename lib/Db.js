...
Db.prototype.createNodeSchema = function (name, schemaProperties, schemaRelationships, opts) {
    opts = _.defaults(opts || {}, this.options);
    var Schema = NodeSchema.create(this, name, schemaProperties, schemaRelationships, opts);
